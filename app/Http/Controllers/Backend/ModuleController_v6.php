...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        ,'modules.subnote','batches.old_file_name')
    ...
    {   
        ...
        ,'modules.subnote','modules.description','batches.old_file_name')
    ...
    public function reportview(Request $request)
    {
        ...
        $data['file'] = DB::table('batches')
          ...
          $data['notes'] = DB::table('modules')
              ->select('modules.id', 'modules.name','modules.created_at  as updated_at','modules.description', 'modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.name as note_name','modules.file_name', 'modules.file_path', 'subjects.name as designame','modules.note_no')
              ->join('batches', 'modules.batch_id', '=', 'batches.id')
              ->join('participants', 'modules.created_by', '=', 'participants.id')
              ->join('subjects', 'participants.desig_id', '=', 'subjects.id')
        ...
        $data['subnotes'] = DB::table('modules')
              ->select('modules.id', 'modules.name','modules.created_at  as updated_at','modules.description', 'modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.name as note_name','modules.file_name', 'modules.file_path', 'subjects.name as designame','modules.note_no','modules.subnote')
              ->join('batches', 'modules.batch_id', '=', 'batches.id')
              ->join('participants', 'modules.created_by', '=', 'participants.id')
              ->join('subjects', 'participants.desig_id', '=', 'subjects.id')
              ->where('modules.batch_id', '=', $data['file']->id)
