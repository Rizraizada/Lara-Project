...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        $data['moduleList'] = DB::table('modules')
            ->select(
                ...
                'modules.month',
                'modules.tranche',
                'intakes.name as department',
                'batches.year',
                'modules.note_status',
                'modules.note_no',
                'modules.subnote',
                'batches.old_file_name'
            )
    ...
    public function report($id)
    {
        ...
        $data['module'] = DB::table('modules')
            ->select('modules.id', 'modules.name', 'modules.created_at as updated_at', 'modules.description', 'modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.file_name', 'modules.file_path', 'subjects.name as designame', 'modules.note_no', 'modules.subnote', 'modules.created_by')
            ->join('batches', 'modules.batch_id', '=', 'batches.id')
        ...
        $data['remarklist'] = DB::table('module_wise_courses')
            ->select('modules.id', 'module_wise_courses.subject_id', 'participants.name', 'module_wise_courses.remarks', 'module_wise_courses.flag', 'module_wise_courses.updated_at', 'subjects.name as designame', 'intakes.name as deptname', 'module_wise_courses.file_name', 'module_wise_courses.file_path')
    ...
    public function reportview(Request $request)
    {
        ...
        $data['notes'] = DB::table('modules')
            ->select('modules.id', 'modules.name', 'modules.created_at  as updated_at', 'modules.description', 'modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.name as note_name', 'modules.file_name', 'modules.file_path', 'subjects.name as designame', 'modules.note_no', 'modules.created_by')
            ->join('batches', 'modules.batch_id', '=', 'batches.id')
            ->join('participants', 'modules.created_by', '=', 'participants.id')
            ->join('subjects', 'participants.desig_id', '=', 'subjects.id')
        ...
        $data['subnotes'] = DB::table('modules')
            ->select('modules.id', 'modules.name', 'modules.created_at  as updated_at', 'modules.description', 'modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.name as note_name', 'modules.file_name', 'modules.file_path', 'subjects.name as designame', 'modules.note_no', 'modules.subnote', 'modules.created_by')
            ->join('batches', 'modules.batch_id', '=', 'batches.id')
            ->join('participants', 'modules.created_by', '=', 'participants.id')
            ->join('subjects', 'participants.desig_id', '=', 'subjects.id')
            ->where('modules.batch_id', '=', $data['file']->id)
        ...
        $data['allnotes'] = DB::table('modules')
            ->select('modules.id', 'modules.batch_id as fileid', 'modules.name as note_name', 'modules.file_name', 'modules.file_path', 'modules.note_no', 'modules.subnote')
            ->join('batches', 'modules.batch_id', '=', 'batches.id')
            ->where('modules.batch_id', '=', $data['file']->id)
            ->get();
        ...
        $data['remarklist'] = DB::table('module_wise_courses')
            ->select('modules.id', 'module_wise_courses.subject_id', 'participants.name', 'module_wise_courses.remarks', 'module_wise_courses.flag', 'module_wise_courses.updated_at', 'subjects.name as designame', 'module_wise_courses.file_name', 'module_wise_courses.file_path')
            ->join('modules', 'module_wise_courses.module_id', '=', 'modules.id')
            ->join('participants', 'module_wise_courses.subject_id', '=', 'participants.id')
            ->join('subjects', 'participants.desig_id', '=', 'subjects.id')
            ->where('modules.batch_id', '=', $data['file']->id)
        ...
        if (auth()->user()->role == '2' && auth()->user()->replace_flow != '1') {
            $data['notelistall'] = DB::table('modules')
                ->select(
                    ...
                    'modules.created_at',
                    'modules.updated_at',
                    'participants.name as created_by'
                )
                ->join('batches', 'batches.id', '=', 'modules.batch_id')
                ->join('intakes', 'batches.intake_id', '=', 'intakes.id')
                ->join('participants', 'modules.created_by', '=', 'participants.id')
