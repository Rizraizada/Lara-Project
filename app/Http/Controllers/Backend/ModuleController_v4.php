...
foreach ($data['approval'] as $object) {
    ...
    {
        $data['module'] = DB::table('modules')
            ->select('modules.id', 'modules.name','modules.created_at as updated_at','modules.description','modules.month', 'modules.batch_id', 'batches.name as filename', 'participants.name as created_name', 'modules.file_name', 'modules.file_path', 'subjects.name as designame', 'participants.signature_file_path')
