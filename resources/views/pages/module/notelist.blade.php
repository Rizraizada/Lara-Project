...
<div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <ul>
                ...
                <a href="{{ route('note.list') }}" title="Course"> List of All Notes</a>
            </ul>
        </div>
       ...
       <div class="row">
        ...
        <br>
                ...
                <div class="row">
                    ...
                    <button type="submit" class="btn btn-info" name="action" value="searchnote">Find note by note subject</button>

                    <button type="submit" class="btn btn-success" name="action" value="fileandnote">Find note by File name & Note No. </button>
    ...
    @foreach ($notelistall as $request)
        <tr>
             ...
             @endphp
            <td>{{ $notelistall->firstItem() + $loop->index }} </td>
     ...
     <div class="d-felx justify-content-center">
        ...
        <p>
        Displaying {{$notelistall->count()}} of {{ $notelistall->total() }} Note(s).
        </p>
