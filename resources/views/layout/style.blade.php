...
<!-- Flaticon CSS -->
<link rel="stylesheet" href="{{ asset('theme/fonts/flaticon.css') }}">
<!-- Full Calender CSS -->
...
<link rel="stylesheet" href="{{ asset('theme/css/datepicker.min.css') }}">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.0-rc.1/css/select2.min.css" />
<!-- Custom CSS -->
<link rel="stylesheet" href="{{ asset('theme/style.css') }}">

<link rel="stylesheet" href="{{ asset('theme/css/multi-select.css') }}">
